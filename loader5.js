...
function load_exploit(){
 ...
 setTimeout(function(){
  document.getElementById('log').innerHTML =
  '<h1 style=color:#c5c7ff>Đang tải Jailbreak... Vui lòng chờ !!!</h1>';
 }, 50); 
}
...
function load_exploit_already(){
 ...
 setTimeout(function(){
  document.getElementById('log').innerHTML =
  '<h1 style=color:#c5c7ff>Jailbreak đã được tải sẵn !!!</h1>';
 }, 50); 
 setTimeout(ani2, 4000);
}
...
function goldhen_already(){
 ...
 setTimeout(function(){
  document.getElementById('log').innerHTML =
  '<h1 style=color:#c5c7ff>GoldHEN BinLoader đã được nạp !!!</h1>';
 }, 50); 
 setTimeout(ani2, 4000);
}
