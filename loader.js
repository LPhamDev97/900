...
function awaitpl(){
 ...
 setTimeout(function(){
  ...
  '<h1 style=color:#c5c7ff>Đang tải Payload...</h1>';
 }, 50);
 setTimeout(function(){
  document.getElementById("log").innerHTML =
  "<h1 style=color:#c5c7ff>"+LoadedMSG+"</h1>";
 }, 800);
...
function load_exploit(){
 ...
 setTimeout(function(){
  document.getElementById('log').innerHTML =
  '<h1 style=color:#c5c7ff>Đang khai thác jailbreak... Vui lòng chờ !!!</h1>';
 }, 50); 
}
...
function load_exploit_already(){
 ...
 setTimeout(function(){
  document.getElementById('log').innerHTML =
  '<h1 style=color:#c5c7ff>Exploit đã được tải trước đó!!!</h1>';
 }, 50); 
 setTimeout(ani2, 4000);
}
...
function goldhen_already(){
 ...
 setTimeout(function(){
  document.getElementById('log').innerHTML =
  '<h1 style=color:#c5c7ff>GoldHEN BinLoader đã sẵn sàng !!!</h1>';
 }, 50); 
 setTimeout(ani2, 4000);
}
...
function load_exploit_done(){
 ...
 setTimeout(function(){
  document.getElementById('log').innerHTML =
  '<h1 style=color:#c5c7ff>Jailbreak thành công !!! Đã nạp GoldHEN v2.4b18.7 !!!</h1>';
 }, 50); 
 setTimeout(ani2, 4000);
}
...
function LoadFromGHBLS(PLfile){
 ...
 req.onerror=function(){
  alert("Không thể tải Payload vì BinLoader chưa được chạy");
  return;
 };
 req.onload=function(){
...
function CalcTime(dur){
 ...
 if (min!=0){
  ShowDuration=" - Khai thác thành công trong: "+min+" phút, "+sec+" giây";
 } else {
  ShowDuration=" - Khai thác thành công trong: "+sec+" giây";
 }
}
